...
N.host="http://123.56.111.132"; 	//host
N.pingback_arr=new Array(10);
N.pb_file="orz_pv.gif";			//gif
N.stay_time=0;
...
N.send_pb=function(name,link){
	...
	N.last_pb_time=d;
	N.pingback( N.host + "/"+N.pb_file+"?p="+N.pvid+"&t=" + d.getTime() +"&n="+name+"&r="+N.sogou_document_refer+"&l="+link+"&ln="+N.getSession()+"&s="+(d-N.load_time)+"&a="+act_time+"&v="+N.version+"&ml="+ml+"&sgsa_id="+N.getCookie("sgsa_id")+"&ua="+N.getUa()+"&se="+N.tags.se+"&sw="+N.tags.sw+"&ds="+N.getDs()+"&cl="+N.getCl()+"&ui="+N.getUserId()+"&pf="+N.getPF()+"&ol="+N.getOnloadtime());
}
...
B.add(document,"click",click);
B.add(document,"mousemove",mousemove);
